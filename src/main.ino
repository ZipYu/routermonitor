...
const char *ssid = "WirelessInternet";         // 连接WiFi名（此处使用taichi-maker为示例）
                                    // 请将您需要连接的WiFi名填入引号中
const char *password = "superfast213"; // 连接WiFi密码（此处使用12345678为示例）
...
void getTemperature()
{
    if (getNetDataInfo("sensors.temp_thermal_zone2_hwmon_hwmon3", netChartData))
    {
